...
python src/predict.py --testfile $file --split_mode $mode --split_train_ratio $train_ratio --split_valid_ratio $valid_ratio --split_seed $seed --modelfile $model --gpu_ids  $gpus --out_path $out